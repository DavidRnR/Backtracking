...
public class BacktrackingArrayList {
	ArrayList<Integer> numbers = new ArrayList<Integer>();

	public BacktrackingArrayList () {
		numbers.add(4);
		numbers.add(1);
		numbers.add(2);
		numbers.add(6);
	...
	private boolean isSolution(ArrayList<Integer> numb,ArrayList<Integer> group) {
		...
		return plus1 == plus2 && plus2 == plus3 && plus1 == plus3;
	}
	...
	public static void main(String[] args) {
		BacktrackingArrayList b = new BacktrackingArrayList();
	}
}
